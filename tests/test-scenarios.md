# test-scenarios.md — Skill 188: technical-diving-decompression-training
...
- **Input:** a typical Technical Diving Decompression Physiology & Safety case with complete inputs.
...
- **Verdict target:** Safe / Conservative Plan.
...
### Verdict coverage
Safe / Conservative Plan, Conditional (experience/fitness), High Risk / Revise, Inconclusive.
